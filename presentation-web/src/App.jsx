...
function MethodologySlide() {
  return <section className="methodology-slide" aria-labelledby="methodology-title"><div className="section-heading"><p>13 — LAMPIRAN METODOLOGI</p><h2 id="methodology-title">Rancangan <span>Pengujian PCY</span></h2></div><div className="methodology-grid"><article><span>KONFIGURASI TETAP</span><strong>18.294 basket</strong><p>100.003 bitmap bucket · 2 pass PCY · dataset bersih yang sama untuk seluruh percobaan.</p></article><article><span>PENGUKURAN UTAMA</span><strong>Runtime &amp; RAM</strong><p>Dicatat bersama jumlah frequent item, kandidat pair, dan frequent pair pada setiap minimum support.</p></article><article><span>PENGULANGAN</span><strong>5× pada 1–3%</strong><p>Nilai runtime yang ditampilkan adalah rata-rata lima percobaan dengan konfigurasi yang sama.</p></article><article><span>BATAS EKSPERIMEN</span><strong>1× pada 5–10%</strong><p>Pengujian tidak diulang karena tidak ditemukan frequent pair; hasil dipakai untuk menunjukkan batas minimum terlalu tinggi.</p></article></div><aside className="methodology-note"><b>Catatan interpretasi:</b> semua hasil dibandingkan pada dataset dan konfigurasi PCY yang sama. Perbedaan runtime kecil antarpercobaan dapat dipengaruhi kondisi perangkat saat eksekusi.</aside></section>
}
